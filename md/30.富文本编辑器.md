...
![](./assets/30.富文本编辑器/屏幕截图185_拷贝.jpg)
...
![](./assets/30.富文本编辑器/屏幕截图182.jpg)

发表含有代码块的评论，详情页面的显示如下：

![](./assets/30.富文本编辑器/屏幕截图183.jpg)
