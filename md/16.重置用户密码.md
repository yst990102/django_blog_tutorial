...
![](./assets/16.重置用户密码/屏幕截图76.jpg)

点击最后一行的链接“这里”：

![](./assets/16.重置用户密码/屏幕截图77.jpg)

按照要求输入用户名或者Email，点击确认按钮：

![](./assets/16.重置用户密码/屏幕截图78a.jpg)

提示已经把重置密码的链接发到邮箱中了。

前往Email中查看新邮件：

![](./assets/16.重置用户密码/屏幕截图79.jpg)

居然神奇的收到了邮件！继续点击邮件中的链接：

![](./assets/16.重置用户密码/屏幕截图81.jpg)

按照提示输入新密码后：

![](./assets/16.重置用户密码/屏幕截图80.jpg)
